...
class ParamExtractor:
    ...
    async def simple_extraction(self, question: str):
        ...
        ## Пример 'Если ответ на вопрос есть и пользователь отвечает на вопрос отрицательно': 
        Вопрос: 'Подскажите, объект ставится под охрану?'
        История диалога: 'Пользователь: не могу поставить объект под охрану. Ассистент: Похоже, возникла неисправность. Чтобы понять, в чём именно дело, мне нужно уточнить некоторые детали. Видите ли вы механические повреждения охранного оборудования (повреждено крепление, корпус, обрыв кабеля и т.д.)?, Пользователь: нет'
        Твой ответ: 'отрицательно'
